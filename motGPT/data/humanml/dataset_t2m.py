...
class Text2MotionDataset(data.Dataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        print(f'[Text2MotionDataset] {split} dataset loading done', len(self.data_dict))
    ...
    def __getitem__(self, item):
        ...
        return caption, None, None, motion, m_length, None, None, None, None, all_captions, None, fname
