...
class Renderer:
    ...
    def __init__(self,
        ...
        self.floor_pose = np.array(
            [[1, 0, 0, 0], [0, np.cos(np.pi / 2), -np.sin(np.pi / 2), miny + 0.1],
    ...
    def __call__(self, vertices, camera_translation):
        ...
        cam_t = camera_translation[0] if isinstance(camera_translation, list) else camera_translation
