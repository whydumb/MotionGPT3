...
def get_named_beta_schedule(schedule_name, num_diffusion_timesteps, beta_start=0.00085, beta_end=0.012):
    """
...
class GaussianDiffusion:
    ...
    def p_mean_variance(self, model, x, t, clip_denoised=True, denoised_fn=None, model_kwargs=None):
        ...
        if self.model_var_type in [ModelVarType.LEARNED, ModelVarType.LEARNED_RANGE]:
            if len(x.shape)==2:
                ...
                assert model_output.shape == (B, x.shape[1], C * 2, *x.shape[3:])
    ...
    def training_losses(self, model, x_start, t, model_kwargs=None, noise=None):
        ...
        if self.loss_type == LossType.KL or self.loss_type == LossType.RESCALED_KL:
            ...
            model_output = model(x_t, t, **model_kwargs)  # bs, 1, 512
            ...
            if self.model_var_type in [
                ...
                if len(x_t.shape)==2:
                    ...
                    assert model_output.shape == (B, x_t.shape[1], C * 2, *x_t.shape[3:])
                    model_output, model_var_values = th.split(model_output, C, dim=2)
