...
class MLM(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # self.language_model.resize_token_embeddings(self.text_vocab_size)
        if not text_trained and text_embeddings_num > len_raw_tokenizer:
            ...
            self.language_model.lm_head.weight.register_hook(
                lambda grad: mask_grad(grad, allow_ids)
            )
    ...
    def generate_direct(self,
        ...
        with torch.no_grad():
            if self.lm_type == 'encdec':
                ...
                outputs = self.language_model.generate(
                    ...
                    motion_holder_repeat = self.motion_holder_repeat,
                    holder_id = self.motion_holder_id_out-self.text_vocab_size,
        ...
        outputs_string = self.tokenizer.batch_decode(output_ids, skip_special_tokens=False)
